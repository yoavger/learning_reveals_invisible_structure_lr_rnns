...
This repository contains code for our [work](https://arxiv.org/abs/2605.04115) extending the low-rank RNN framework from activity to learning dynamics. We derive a closed-form, low-dimensional system of ODEs governing learning in overlap space, exact for linear RNNs and asymptotically exact for nonlinear RNNs in the large-N Gaussian limit using dynamical mean-field theory. 
